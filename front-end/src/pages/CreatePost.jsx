...
const createPost = () => {
  ...
  const generateImage = async () =>{
      if(form.prompt){
        try {
          ...
          const response = await fetch("https://imaginary-fh4p.onrender.com/api/v1/dalle",{
            method:"POST",
            headers:{
  ...
  const handleSubmit = async (e) =>{
    ...
    {
      alert("Please a prompt and generate an image to share")
    }
  }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div> 
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[600px]'>Create imaginative and visually stunning images and share with community</p>
      </div>
